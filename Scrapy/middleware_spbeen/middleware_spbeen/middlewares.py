...
class MiddlewareSpbeenDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class MiddlewareSpbeenRandomUseragent(object):
    def __init__(self):
        self.fake = Faker()
...
class MiddlewareSpbeenRandomUseragent2(UserAgentMiddleware):
    def __init__(self, user_agent='Scrapy'):
        self.user_agent = user_agent ## this is like faker

    @classmethod
    def from_crawler(cls, crawler):
        o = cls(Faker()) #this set the above user_agent as Faker()
